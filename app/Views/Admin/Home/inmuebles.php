...
<img src="<?= base_url('uploads') . "/"; ?><?php echo $dato['foto']; ?>" class="img-fluid mb-2" alt="white sample" width="80" />
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="<?= base_url('Inmuebles/edit/' . $dato['id_inmueble']) ?>" role="button">Editar</a>
                                        <a class="btn btn-danger eliminar" href="<?= base_url('Inmuebles/eliminar/' . $dato['id_inmueble'] )?>" role="button">Eiminar</a>
