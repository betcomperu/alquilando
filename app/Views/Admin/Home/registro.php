    ...
    <div class="swal" data-swal="<?= session()->get('registrado')?>"></div>
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form enctype="multipart/form-data" id="form_validation" method="post" action="<?php echo base_url(); ?>/inmuebles/insertar">
            <div class="card-body">
            <input id="idusuario" name="idusuario" type="hidden" value="<?php echo session()->get('idusuario');   ?>">
              <div class="form-group">
                <label for="text">Dirección</label>
                <input type="texto" value="<?= old('direccion') ?>" class="form-control" id="direccion" name="direccion" placeholder="Ingrese la dirección del inmueble">
                <p class="text text-danger"><?= session('errors.direccion') ?></p>
              </div>
              <div class="form-group">
                <label for="text">Detalles</label>
                <input type="texto" value="<?= old('detalles') ?>" class="form-control" id="detalles" name="detalles" placeholder="Detalles del inmueble">
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-primary registrar"><i class="fa fa-plus-circle"></i> Registrar</button>
